...
public abstract class SwingWorker<T, V> implements Future<T>, Runnable {
    ...
    public enum StateValue {
        ...
        /** The STARTED. {@code SwingWorker} is {@code STARTED} before invoking {@code doInBackground}. */
        STARTED,

        /** The DONE. {@code SwingWorker} is {@code DONE} after {@code doInBackground} method is finished. */
        DONE
    };
    ...
    /**
     * The Class DoSubmitAccumulativeRunnable.
     */
    private static class DoSubmitAccumulativeRunnable 
        ...
        /* (non-Javadoc)
         * @see org.nuclearmasses.gui.util.AccumulativeRunnable#run(java.util.List)
         */
        @Override
        ...
        /* (non-Javadoc)
         * @see org.nuclearmasses.gui.util.AccumulativeRunnable#submit()
         */
        @Override
        protected void submit() {
    ...
    /**
     * The Class SwingWorkerPropertyChangeSupport.
     */
    private class SwingWorkerPropertyChangeSupport 
            extends PropertyChangeSupport {
        
        /**
         * Instantiates a new swing worker property change support.
         *
