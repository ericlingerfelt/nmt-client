...
/**
 * This class is Step 1 of 4 for the Mass Dataset Analyzer > Mass Dataset RMS Calculator.
 */
public class AnalCalc1Panel extends JPanel implements MassModelTreeListener
	 ...
	 */
	public AnalCalc1Panel(AnalDataStructure ds){
		...
		label.setText("<html>Select mass datasets for calculation by double-clicking it in the tree below left. Remove a mass dataset"
