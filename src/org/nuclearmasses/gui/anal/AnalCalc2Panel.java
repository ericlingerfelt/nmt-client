...
/**
 * This class is Step 2 of 4 for the Mass Dataset Analyzer > Mass Dataset RMS Calculator.
 */
public class AnalCalc2Panel extends JPanel implements MassModelTreeListener, StateAccessor{
	 ...
	 */
	public AnalCalc2Panel(AnalDataStructure ds){
