 ...
 * for the Mass Dataset Analyzer > Mass Dataset RMS Calculator.
 */
public class AnalCalcTableFrame extends JFrame implements ActionListener{
     ...
     * @param frame a reference to the {@link AnalCalcPlotFrame} spawning this class
     */
    public AnalCalcTableFrame(AnalDataStructure ds, MainDataStructure mds, AnalCalcPlotFrame frame){
