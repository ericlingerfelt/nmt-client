...
/**
 * This class is Step 3 of 5 for the Mass Dataset Analyzer > Mass Dataset RMS Comparator.
 */
public class AnalComp3Panel extends JPanel implements ActionListener, AnalChartListener, StateAccessor{
	 ...
	 * @param parent a {@link JFrame} reference to pass to the {@link AnalChartFrame}
	 */
	public AnalComp3Panel(AnalDataStructure ds, JFrame parent){
