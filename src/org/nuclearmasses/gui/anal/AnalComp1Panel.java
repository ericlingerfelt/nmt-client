...
/**
 * This class is Step 1 of 5 for the Mass Dataset Analyzer > Mass Dataset RMS Comparator.
 */
public class AnalComp1Panel extends JPanel implements MassModelTreeListener
	 ...
	 */
	public AnalComp1Panel(AnalDataStructure ds){
		...
		label.setText("<html>Select mass datasets for comparison by double-clicking it in the tree below left. Remove a mass dataset"
